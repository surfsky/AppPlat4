...
namespace App.Admins
{
    ...
    public partial class FeedbackForm2 : FormPage<Feedback>
    {
        ...
        protected void ddlNextStep_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (nextStatus != null)
            {
                ...
                pbUser.UrlTemplate = Urls.GetUsersUrl(null, power);
                pbUser.Hidden = (nextStep.Type == WFStepType.End);
            }
        }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            // 指定后继处理人（可选，未启用）
            DAL.User nextStepUser = null;
            var userId = UI.GetLong(pbUser);
            if (userId != null)
                nextStepUser = DAL.User.Get(userId);
