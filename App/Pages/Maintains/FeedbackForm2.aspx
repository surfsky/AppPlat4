<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeedbackForm2.aspx.cs"  Inherits="App.Admins.FeedbackForm2" ValidateRequest="false" %>
            ...
            <Items>
                ...
                <f:Window runat="server" ID="winFlow" Width="600" Height="400" Hidden="true" EnableResize="true" Target="Top" BodyPadding="10" Title="请选择后继步骤"  >
                    ...
                    <Items>
                        ...
                        <f:PopupBox runat="server" ID="pbUser" Label="指定处理人" WinTitle="指定处理人" WinWidth="800" WinHeight="600" ShowSearcher="false" />
